    ...
    <?php defined('BASEPATH') OR exit('No direct script access allowed');
     $this->load->view('includes/header_portion'); ?> 
      <div class="content-wrapper" style="padding: 1rem 2.2rem;">
        <div class="row">
          <div class="col-md-7">
            <!-- <video crossorigin="" playsinline="" poster="../uploads/images/<?php echo $item_images->img_url;?>" id="player" src="../uploads/videos/<?php echo $item->media;?>"> -->
            ...
            <div class="row intro-title">
              ...
              <div class="register-btn" style="right: 15px;">
                <span>チャンネル登録</span>&nbsp;
                  ...
                  <?php } else{ ?>
                      <span><?php echo $category->subscribe;?>人</span>
                  <?php } ?>
              </div>
            </div>

              ...
              <div class="row ml-0">
                <div class="col-2 ml-0" style="background-color: #F5F5F5;">
                  <div class="row">
                    <div class="sel-item" onclick="select_img()">
                      <div class="row">
                        <div class="col-sm-3">
                          <span class="mdi mdi-home" style="font-size: 25px;line-height: 25px;"></span>
                        </div>
                  ...
                  <div class="row">
                    <div class="sel-item active" onclick="select_mylist()" style="border-bottom: 1px solid #c3c3c3;">
                      <div class="row">
                        <div class="col-sm-3">
                          <span class="mdi mdi-heart" style="color: red; font-size: 25px;line-height: 25px;"></span>
                        </div>
                        <div class="col-sm-9" style="text-align: left;">
                ...
                <div class="col-10 pl-4 pr-4 pt-0" style="background-color: #FAFAFA;">
                  <div class="row intro-title">
                    <span>マイリスト</span>&nbsp;&nbsp;&nbsp;
                    <span class="recommand-channel"></span>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-1" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                      ...
                      <p class="m-0" style="padding-top: 5px;font-weight: bold;font-size: 12px;">Local Youtube</p>
                      <?php if($item->views > 0){?>
                      <p class="p-0 m-0" style="font-weight: bold;font-size: 12px;"><?php echo $item->views;?>回視聴</p>
                      <?php } ?>
                    </div>    
